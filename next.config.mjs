...
const nextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "images.totalbeauty.com",
        pathname: "**",
      },
      {
        protocol: "https",
